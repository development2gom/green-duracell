...
class SiteController extends Controller
{
    ...
    public function actionExportarUsuariosCsv(){
        ...
        if($nuevoFichero){
            ...
            SELECT U.txt_username, U.num_edad, U.txt_telefono, U.txt_email, U.fch_creacion,T.uddi, T.txt_sucursal, B.txt_nombre, T.txt_codigo, puntos.num_puntos, U.num_puntuacion
        ...
        if(isset($_POST['sucursal']) && isset($_POST['codigo_ticket']) && isset($_POST['productos']) && isset($_POST['codigo_barras']) && isset($_POST['seriales'])){
            ...
            foreach($_POST['productos'] as $key => $value){ 
                try{
                    ...
                    $producto->num_puntos = $productoConstante['num_valor'];
